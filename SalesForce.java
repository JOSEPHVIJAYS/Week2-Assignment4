...
public class SalesForce {
	...
	public static void main(String[] args) {
		...
		// filling the form
		driver.findElement(By.name("UserFirstName")).sendKeys("Joseph");
		driver.findElement(By.name("UserLastName")).sendKeys("Vijsy");
		
		driver.findElement(By.name("UserEmail")).sendKeys("josephvijay@gmail.com");

...
public class Day4 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_birthDate")).sendKeys("04/07/1999");
		...
		driver.findElement(By.id("createLeadForm_primaryPhoneNumber")).sendKeys("678910");
		...
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("josephvijay281298@gmail.com");
		driver.findElement(By.id("createLeadForm_primaryWebUrl")).sendKeys("http://amazon.com");
